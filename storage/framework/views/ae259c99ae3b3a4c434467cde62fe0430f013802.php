      ...
      <div class="row">
        ...
        <div class="col-sm-6">
            <div class="text-center">
              <img src="<?php echo e(asset('images/logo.png')); ?>" class="img-fluid logo" alt="logo">
            </div>
        </div>
          ...
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="initialize-system" role="tabpanel" aria-labelledby="initialize-system-list">
              ...
              <div class="col-sm-12">
                ...
                <div class="col-sm-3">
                  <div class="tile text-center">
                    <a href="<?php echo e(route('course.index')); ?>" class="process-link"> <i class="fas fa-desktop"></i><br>Courses settings</a>
                  </div>
                </div>
...
<?php echo $__env->make('inc/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CrcsMally\resources\views/root/main.blade.php ENDPATH**/ ?>